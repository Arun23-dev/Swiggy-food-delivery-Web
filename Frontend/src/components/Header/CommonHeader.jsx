    ...
    <div>
      <div className="px-5  fixed top-0 w-full h-[80px]  mb-[100px]   z-50 bg-white shadow-sm">
        <div className="flex justify-between max-w-[1200px] h-[80px] mx-auto container   items-center">
          ...
          <div className="flex justify-center gap-3">
            ...
            <div className="flex items-center ml-[30px] space-x-2">
              <div className="flex flex-col items-start">
                <span className="font-semibold text-[16px]">Other</span>
                <span className="w-10 h-[2px] bg-black mt-[2px]" />
              </div>

              {/* Location text */}
              <span className="text-gray-600 text-[16px]">Delhi, India</span>
          ...
          <div className="flex justify-center gap-13 font-normal text-[16px] color-[#02060CE6]">
